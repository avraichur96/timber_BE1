...
if ENV == 'development' and not config('USE_POSTGRES', default=False, cast=bool):
    DATABASES = {
        'default': {
...
if EMAIL_PROVIDER == 'mailtrap':
    ...
    if MAILTRAP_AUTH_METHOD == 'token':
        ...
        EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD', default='d005c487ee6871f3b32420aac1b7d85b')
